...
CAPITAL_CITIES_NORMALIZED = {normalize_city_name(c) for c in CAPITAL_CITIES if c}
...
                is_capital = city_normalized in CAPITAL_CITIES_NORMALIZED if city_normalized else False
...
                        is_weekend = int(dt.dayofweek) >= 5  # 0=Mo, 6=So
                    except Exception:
                        weekday = None
                        is_weekend = None
...
                        ticket_price_avg = round((ticket_price_min + ticket_price_max) / 2, 2)
...
    if not artist_id:
        print("  ❌ Nicht gefunden auf Ticketmaster")
        continue
